    ...
    partial class AboutBox : Form
    {
        ...
        public string AssemblyTitle
        {
            get
            {
                ...
                ZlpPathHelper.GetFileNameFromFilePath(Assembly.GetExecutingAssembly().CodeBase);
                int last = returnString.LastIndexOf('.');
                returnString = returnString.Substring(0,last);
                return returnString;
            }
        }
